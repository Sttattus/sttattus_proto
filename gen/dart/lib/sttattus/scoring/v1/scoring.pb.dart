...
class ScoreMatchRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScoreMatchRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.scoring.v1'), createEmptyInstance: create)
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'swiperIntellectualPace', $pb.PbFieldType.O3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'swiperEmotionalGranularity', $pb.PbFieldType.O3)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'swiperPhysicalDrive', $pb.PbFieldType.O3)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'swiperSocialBattery', $pb.PbFieldType.O3)
    ..a<$core.int>(7, _omitFieldNames ? '' : 'targetIntellectualPace', $pb.PbFieldType.O3)
    ..a<$core.int>(8, _omitFieldNames ? '' : 'targetEmotionalGranularity', $pb.PbFieldType.O3)
    ..a<$core.int>(9, _omitFieldNames ? '' : 'targetPhysicalDrive', $pb.PbFieldType.O3)
    ..a<$core.int>(10, _omitFieldNames ? '' : 'targetSocialBattery', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
