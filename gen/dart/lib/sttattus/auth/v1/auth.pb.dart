...
class ProfileHint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<AuthProvider>(
        7, _omitFieldNames ? '' : 'linkedProviders', $pb.PbFieldType.KE,
        valueOf: AuthProvider.valueOf,
        enumValues: AuthProvider.values,
        defaultEnumValue: AuthProvider.AUTH_PROVIDER_UNSPECIFIED)
...
class RegisterResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ProfileHint>(4, _omitFieldNames ? '' : 'existingProfile',
        subBuilder: ProfileHint.create)
    ..hasRequiredFields = false;
...
class OAuthLoginRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.auth.v1'),
      createEmptyInstance: create)
    ..aE<AuthProvider>(1, _omitFieldNames ? '' : 'provider',
        enumValues: AuthProvider.values)
...
class OAuthLoginResponse extends $pb.GeneratedMessage {
  ...
  factory OAuthLoginResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory OAuthLoginResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OAuthLoginResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class LinkProviderRequest extends $pb.GeneratedMessage {
  ...
  factory LinkProviderRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory LinkProviderRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LinkProviderRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.auth.v1'),
      createEmptyInstance: create)
    ..aE<AuthProvider>(1, _omitFieldNames ? '' : 'provider',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LinkProviderRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LinkProviderRequest copyWith(void Function(LinkProviderRequest) updates) =>
      super.copyWith((message) => updates(message as LinkProviderRequest))
          as LinkProviderRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static LinkProviderRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LinkProviderRequest>(create);
...
class LinkProviderResponse extends $pb.GeneratedMessage {
  ...
  factory LinkProviderResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory LinkProviderResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LinkProviderResponse',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.auth.v1'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LinkProviderResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LinkProviderResponse copyWith(void Function(LinkProviderResponse) updates) =>
      super.copyWith((message) => updates(message as LinkProviderResponse))
          as LinkProviderResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static LinkProviderResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LinkProviderResponse>(create);
...
class ExchangeOAuthHandoffRequest extends $pb.GeneratedMessage {
  ...
  factory ExchangeOAuthHandoffRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ExchangeOAuthHandoffRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ExchangeOAuthHandoffRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.auth.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'code')
    ..aE<AppCode>(2, _omitFieldNames ? '' : 'appCode',
        enumValues: AppCode.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ExchangeOAuthHandoffRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ExchangeOAuthHandoffRequest copyWith(
          void Function(ExchangeOAuthHandoffRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ExchangeOAuthHandoffRequest))
          as ExchangeOAuthHandoffRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ExchangeOAuthHandoffRequest create() =>
      ExchangeOAuthHandoffRequest._();
  @$core.override
  ExchangeOAuthHandoffRequest createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ExchangeOAuthHandoffRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ExchangeOAuthHandoffRequest>(create);
...
class ExchangeOAuthHandoffResponse extends $pb.GeneratedMessage {
  ...
  factory ExchangeOAuthHandoffResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ExchangeOAuthHandoffResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ExchangeOAuthHandoffResponse',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.auth.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ExchangeOAuthHandoffResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ExchangeOAuthHandoffResponse copyWith(
          void Function(ExchangeOAuthHandoffResponse) updates) =>
      super.copyWith(
              (message) => updates(message as ExchangeOAuthHandoffResponse))
          as ExchangeOAuthHandoffResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ExchangeOAuthHandoffResponse create() =>
      ExchangeOAuthHandoffResponse._();
  @$core.override
  ExchangeOAuthHandoffResponse createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ExchangeOAuthHandoffResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ExchangeOAuthHandoffResponse>(create);
