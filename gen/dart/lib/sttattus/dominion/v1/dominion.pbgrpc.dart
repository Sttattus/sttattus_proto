...
class DominionServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.ListLoungeEventsResponse> listLoungeEvents($0.ListLoungeEventsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listLoungeEvents, request, options: options);
  }

  $grpc.ResponseFuture<$0.RsvpLoungeEventResponse> rsvpLoungeEvent($0.RsvpLoungeEventRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$rsvpLoungeEvent, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListMyLoungeRsvpsResponse> listMyLoungeRsvps($0.ListMyLoungeRsvpsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listMyLoungeRsvps, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListSalonsResponse> listSalons($0.ListSalonsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listSalons, request, options: options);
  }

  $grpc.ResponseFuture<$0.RsvpSalonResponse> rsvpSalon($0.RsvpSalonRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$rsvpSalon, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListMySalonRsvpsResponse> listMySalonRsvps($0.ListMySalonRsvpsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listMySalonRsvps, request, options: options);
  }

  /// D14.10 — per-property yield / portfolio financials.
  $grpc.ResponseFuture<$0.GetPropertyFinancialsResponse> getPropertyFinancials($0.GetPropertyFinancialsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getPropertyFinancials, request, options: options);
  }

  $grpc.ResponseFuture<$0.UpsertPropertyFinancialsResponse> upsertPropertyFinancials($0.UpsertPropertyFinancialsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$upsertPropertyFinancials, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetPortfolioYieldResponse> getPortfolioYield($0.GetPortfolioYieldRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getPortfolioYield, request, options: options);
  }

  /// D14.11 — region intelligence.
  $grpc.ResponseFuture<$0.ListRegionIntelResponse> listRegionIntel($0.ListRegionIntelRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listRegionIntel, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetRegionIntelResponse> getRegionIntel($0.GetRegionIntelRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getRegionIntel, request, options: options);
  }

  /// D14.12 — cross-pillar allocation contract (Vault).
  $grpc.ResponseFuture<$0.GetTerritoryAllocationResponse> getTerritoryAllocation($0.GetTerritoryAllocationRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getTerritoryAllocation, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.ListDirectoryResponse> listDirectory($0.ListDirectoryRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listDirectory, request, options: options);
  }

  /// D14.17 — off-market opportunities (Sovereign).
  $grpc.ResponseFuture<$0.ListOffMarketResponse> listOffMarket($0.ListOffMarketRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listOffMarket, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetOffMarketResponse> getOffMarket($0.GetOffMarketRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getOffMarket, request, options: options);
  }

  /// D14.19 — real deed parser.
  $grpc.ResponseFuture<$0.ParseDeedResponse> parseDeed($0.ParseDeedRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$parseDeed, request, options: options);
  }

  /// D14.20 — public Dominion profile share.
  $grpc.ResponseFuture<$0.CreateDominionShareResponse> createDominionShare($0.CreateDominionShareRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$createDominionShare, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListMyDominionSharesResponse> listMyDominionShares($0.ListMyDominionSharesRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listMyDominionShares, request, options: options);
  }

  $grpc.ResponseFuture<$0.RevokeDominionShareResponse> revokeDominionShare($0.RevokeDominionShareRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$revokeDominionShare, request, options: options);
  }

  /// D14.21 — annual Dominion Almanac.
  $grpc.ResponseFuture<$0.GenerateDominionAlmanacResponse> generateDominionAlmanac($0.GenerateDominionAlmanacRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$generateDominionAlmanac, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.ListMyLoungePassesResponse> listMyLoungePasses($0.ListMyLoungePassesRequest request, {$grpc.CallOptions? options,}) {
  ...
  static final _$listLoungeEvents = $grpc.ClientMethod<$0.ListLoungeEventsRequest, $0.ListLoungeEventsResponse>(
  ...
  static final _$rsvpLoungeEvent = $grpc.ClientMethod<$0.RsvpLoungeEventRequest, $0.RsvpLoungeEventResponse>(
  ...
  static final _$listMyLoungeRsvps = $grpc.ClientMethod<$0.ListMyLoungeRsvpsRequest, $0.ListMyLoungeRsvpsResponse>(
  ...
  static final _$listSalons = $grpc.ClientMethod<$0.ListSalonsRequest, $0.ListSalonsResponse>(
  ...
  static final _$rsvpSalon = $grpc.ClientMethod<$0.RsvpSalonRequest, $0.RsvpSalonResponse>(
      '/sttattus.dominion.v1.DominionService/RsvpSalon',
      ($0.RsvpSalonRequest value) => value.writeToBuffer(),
      $0.RsvpSalonResponse.fromBuffer);
  static final _$listMySalonRsvps = $grpc.ClientMethod<$0.ListMySalonRsvpsRequest, $0.ListMySalonRsvpsResponse>(
  ...
  static final _$getPropertyFinancials = $grpc.ClientMethod<$0.GetPropertyFinancialsRequest, $0.GetPropertyFinancialsResponse>(
  ...
  static final _$upsertPropertyFinancials = $grpc.ClientMethod<$0.UpsertPropertyFinancialsRequest, $0.UpsertPropertyFinancialsResponse>(
  ...
  static final _$getPortfolioYield = $grpc.ClientMethod<$0.GetPortfolioYieldRequest, $0.GetPortfolioYieldResponse>(
  ...
  static final _$listRegionIntel = $grpc.ClientMethod<$0.ListRegionIntelRequest, $0.ListRegionIntelResponse>(
  ...
  static final _$getRegionIntel = $grpc.ClientMethod<$0.GetRegionIntelRequest, $0.GetRegionIntelResponse>(
  ...
  static final _$getTerritoryAllocation = $grpc.ClientMethod<$0.GetTerritoryAllocationRequest, $0.GetTerritoryAllocationResponse>(
  ...
  static final _$listDirectory = $grpc.ClientMethod<$0.ListDirectoryRequest, $0.ListDirectoryResponse>(
  ...
  static final _$listOffMarket = $grpc.ClientMethod<$0.ListOffMarketRequest, $0.ListOffMarketResponse>(
  ...
  static final _$getOffMarket = $grpc.ClientMethod<$0.GetOffMarketRequest, $0.GetOffMarketResponse>(
  ...
  static final _$parseDeed = $grpc.ClientMethod<$0.ParseDeedRequest, $0.ParseDeedResponse>(
      '/sttattus.dominion.v1.DominionService/ParseDeed',
      ($0.ParseDeedRequest value) => value.writeToBuffer(),
      $0.ParseDeedResponse.fromBuffer);
  static final _$createDominionShare = $grpc.ClientMethod<$0.CreateDominionShareRequest, $0.CreateDominionShareResponse>(
  ...
  static final _$listMyDominionShares = $grpc.ClientMethod<$0.ListMyDominionSharesRequest, $0.ListMyDominionSharesResponse>(
  ...
  static final _$revokeDominionShare = $grpc.ClientMethod<$0.RevokeDominionShareRequest, $0.RevokeDominionShareResponse>(
  ...
  static final _$generateDominionAlmanac = $grpc.ClientMethod<$0.GenerateDominionAlmanacRequest, $0.GenerateDominionAlmanacResponse>(
  ...
  static final _$listMyLoungePasses = $grpc.ClientMethod<$0.ListMyLoungePassesRequest, $0.ListMyLoungePassesResponse>(
...
abstract class DominionServiceBase extends $grpc.Service {
  ...
  DominionServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ListLoungeEventsRequest, $0.ListLoungeEventsResponse>(
        'ListLoungeEvents',
        listLoungeEvents_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListLoungeEventsRequest.fromBuffer(value),
        ($0.ListLoungeEventsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RsvpLoungeEventRequest, $0.RsvpLoungeEventResponse>(
        'RsvpLoungeEvent',
        rsvpLoungeEvent_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.RsvpLoungeEventRequest.fromBuffer(value),
        ($0.RsvpLoungeEventResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListMyLoungeRsvpsRequest, $0.ListMyLoungeRsvpsResponse>(
        'ListMyLoungeRsvps',
        listMyLoungeRsvps_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListMyLoungeRsvpsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ListMySalonRsvpsRequest, $0.ListMySalonRsvpsResponse>(
        'ListMySalonRsvps',
        listMySalonRsvps_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListMySalonRsvpsRequest.fromBuffer(value),
        ($0.ListMySalonRsvpsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetPropertyFinancialsRequest, $0.GetPropertyFinancialsResponse>(
        'GetPropertyFinancials',
        getPropertyFinancials_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetPropertyFinancialsRequest.fromBuffer(value),
        ($0.GetPropertyFinancialsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpsertPropertyFinancialsRequest, $0.UpsertPropertyFinancialsResponse>(
        'UpsertPropertyFinancials',
        upsertPropertyFinancials_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.UpsertPropertyFinancialsRequest.fromBuffer(value),
        ($0.UpsertPropertyFinancialsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetPortfolioYieldRequest, $0.GetPortfolioYieldResponse>(
        'GetPortfolioYield',
        getPortfolioYield_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetPortfolioYieldRequest.fromBuffer(value),
        ($0.GetPortfolioYieldResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListRegionIntelRequest, $0.ListRegionIntelResponse>(
        'ListRegionIntel',
        listRegionIntel_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListRegionIntelRequest.fromBuffer(value),
        ($0.ListRegionIntelResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetRegionIntelRequest, $0.GetRegionIntelResponse>(
        'GetRegionIntel',
        getRegionIntel_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetRegionIntelRequest.fromBuffer(value),
        ($0.GetRegionIntelResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetTerritoryAllocationRequest, $0.GetTerritoryAllocationResponse>(
        'GetTerritoryAllocation',
        getTerritoryAllocation_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetTerritoryAllocationRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ListDirectoryRequest, $0.ListDirectoryResponse>(
        'ListDirectory',
        listDirectory_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListDirectoryRequest.fromBuffer(value),
        ($0.ListDirectoryResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListOffMarketRequest, $0.ListOffMarketResponse>(
        'ListOffMarket',
        listOffMarket_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListOffMarketRequest.fromBuffer(value),
        ($0.ListOffMarketResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetOffMarketRequest, $0.GetOffMarketResponse>(
        'GetOffMarket',
        getOffMarket_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetOffMarketRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.CreateDominionShareRequest, $0.CreateDominionShareResponse>(
        'CreateDominionShare',
        createDominionShare_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.CreateDominionShareRequest.fromBuffer(value),
        ($0.CreateDominionShareResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListMyDominionSharesRequest, $0.ListMyDominionSharesResponse>(
        'ListMyDominionShares',
        listMyDominionShares_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListMyDominionSharesRequest.fromBuffer(value),
        ($0.ListMyDominionSharesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RevokeDominionShareRequest, $0.RevokeDominionShareResponse>(
        'RevokeDominionShare',
        revokeDominionShare_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.RevokeDominionShareRequest.fromBuffer(value),
        ($0.RevokeDominionShareResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GenerateDominionAlmanacRequest, $0.GenerateDominionAlmanacResponse>(
        'GenerateDominionAlmanac',
        generateDominionAlmanac_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GenerateDominionAlmanacRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ListMyLoungePassesRequest, $0.ListMyLoungePassesResponse>(
        'ListMyLoungePasses',
        listMyLoungePasses_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListMyLoungePassesRequest.fromBuffer(value),
  ...
  $async.Future<$0.ListLoungeEventsResponse> listLoungeEvents_Pre($grpc.ServiceCall $call, $async.Future<$0.ListLoungeEventsRequest> $request) async {
    return listLoungeEvents($call, await $request);
  }

  $async.Future<$0.ListLoungeEventsResponse> listLoungeEvents($grpc.ServiceCall call, $0.ListLoungeEventsRequest request);

  $async.Future<$0.RsvpLoungeEventResponse> rsvpLoungeEvent_Pre($grpc.ServiceCall $call, $async.Future<$0.RsvpLoungeEventRequest> $request) async {
    return rsvpLoungeEvent($call, await $request);
  }

  $async.Future<$0.RsvpLoungeEventResponse> rsvpLoungeEvent($grpc.ServiceCall call, $0.RsvpLoungeEventRequest request);

  $async.Future<$0.ListMyLoungeRsvpsResponse> listMyLoungeRsvps_Pre($grpc.ServiceCall $call, $async.Future<$0.ListMyLoungeRsvpsRequest> $request) async {
    return listMyLoungeRsvps($call, await $request);
  }

  $async.Future<$0.ListMyLoungeRsvpsResponse> listMyLoungeRsvps($grpc.ServiceCall call, $0.ListMyLoungeRsvpsRequest request);

  $async.Future<$0.ListSalonsResponse> listSalons_Pre($grpc.ServiceCall $call, $async.Future<$0.ListSalonsRequest> $request) async {
    return listSalons($call, await $request);
  }

  $async.Future<$0.ListSalonsResponse> listSalons($grpc.ServiceCall call, $0.ListSalonsRequest request);

  $async.Future<$0.RsvpSalonResponse> rsvpSalon_Pre($grpc.ServiceCall $call, $async.Future<$0.RsvpSalonRequest> $request) async {
    return rsvpSalon($call, await $request);
  }

  $async.Future<$0.RsvpSalonResponse> rsvpSalon($grpc.ServiceCall call, $0.RsvpSalonRequest request);

  $async.Future<$0.ListMySalonRsvpsResponse> listMySalonRsvps_Pre($grpc.ServiceCall $call, $async.Future<$0.ListMySalonRsvpsRequest> $request) async {
    return listMySalonRsvps($call, await $request);
  }

  $async.Future<$0.ListMySalonRsvpsResponse> listMySalonRsvps($grpc.ServiceCall call, $0.ListMySalonRsvpsRequest request);

  $async.Future<$0.GetPropertyFinancialsResponse> getPropertyFinancials_Pre($grpc.ServiceCall $call, $async.Future<$0.GetPropertyFinancialsRequest> $request) async {
    return getPropertyFinancials($call, await $request);
  }

  $async.Future<$0.GetPropertyFinancialsResponse> getPropertyFinancials($grpc.ServiceCall call, $0.GetPropertyFinancialsRequest request);

  $async.Future<$0.UpsertPropertyFinancialsResponse> upsertPropertyFinancials_Pre($grpc.ServiceCall $call, $async.Future<$0.UpsertPropertyFinancialsRequest> $request) async {
    return upsertPropertyFinancials($call, await $request);
  }

  $async.Future<$0.UpsertPropertyFinancialsResponse> upsertPropertyFinancials($grpc.ServiceCall call, $0.UpsertPropertyFinancialsRequest request);

  $async.Future<$0.GetPortfolioYieldResponse> getPortfolioYield_Pre($grpc.ServiceCall $call, $async.Future<$0.GetPortfolioYieldRequest> $request) async {
    return getPortfolioYield($call, await $request);
  }

  $async.Future<$0.GetPortfolioYieldResponse> getPortfolioYield($grpc.ServiceCall call, $0.GetPortfolioYieldRequest request);

  $async.Future<$0.ListRegionIntelResponse> listRegionIntel_Pre($grpc.ServiceCall $call, $async.Future<$0.ListRegionIntelRequest> $request) async {
    return listRegionIntel($call, await $request);
  }

  $async.Future<$0.ListRegionIntelResponse> listRegionIntel($grpc.ServiceCall call, $0.ListRegionIntelRequest request);

  $async.Future<$0.GetRegionIntelResponse> getRegionIntel_Pre($grpc.ServiceCall $call, $async.Future<$0.GetRegionIntelRequest> $request) async {
    return getRegionIntel($call, await $request);
  }

  $async.Future<$0.GetRegionIntelResponse> getRegionIntel($grpc.ServiceCall call, $0.GetRegionIntelRequest request);

  $async.Future<$0.GetTerritoryAllocationResponse> getTerritoryAllocation_Pre($grpc.ServiceCall $call, $async.Future<$0.GetTerritoryAllocationRequest> $request) async {
    return getTerritoryAllocation($call, await $request);
  }

  $async.Future<$0.GetTerritoryAllocationResponse> getTerritoryAllocation($grpc.ServiceCall call, $0.GetTerritoryAllocationRequest request);
  ...
  $async.Future<$0.ListDirectoryResponse> listDirectory_Pre($grpc.ServiceCall $call, $async.Future<$0.ListDirectoryRequest> $request) async {
    return listDirectory($call, await $request);
  }

  $async.Future<$0.ListDirectoryResponse> listDirectory($grpc.ServiceCall call, $0.ListDirectoryRequest request);

  $async.Future<$0.ListOffMarketResponse> listOffMarket_Pre($grpc.ServiceCall $call, $async.Future<$0.ListOffMarketRequest> $request) async {
    return listOffMarket($call, await $request);
  }

  $async.Future<$0.ListOffMarketResponse> listOffMarket($grpc.ServiceCall call, $0.ListOffMarketRequest request);

  $async.Future<$0.GetOffMarketResponse> getOffMarket_Pre($grpc.ServiceCall $call, $async.Future<$0.GetOffMarketRequest> $request) async {
    return getOffMarket($call, await $request);
  }

  $async.Future<$0.GetOffMarketResponse> getOffMarket($grpc.ServiceCall call, $0.GetOffMarketRequest request);

  $async.Future<$0.ParseDeedResponse> parseDeed_Pre($grpc.ServiceCall $call, $async.Future<$0.ParseDeedRequest> $request) async {
    return parseDeed($call, await $request);
  }

  $async.Future<$0.ParseDeedResponse> parseDeed($grpc.ServiceCall call, $0.ParseDeedRequest request);

  $async.Future<$0.CreateDominionShareResponse> createDominionShare_Pre($grpc.ServiceCall $call, $async.Future<$0.CreateDominionShareRequest> $request) async {
    return createDominionShare($call, await $request);
  }

  $async.Future<$0.CreateDominionShareResponse> createDominionShare($grpc.ServiceCall call, $0.CreateDominionShareRequest request);

  $async.Future<$0.ListMyDominionSharesResponse> listMyDominionShares_Pre($grpc.ServiceCall $call, $async.Future<$0.ListMyDominionSharesRequest> $request) async {
    return listMyDominionShares($call, await $request);
  }

  $async.Future<$0.ListMyDominionSharesResponse> listMyDominionShares($grpc.ServiceCall call, $0.ListMyDominionSharesRequest request);

  $async.Future<$0.RevokeDominionShareResponse> revokeDominionShare_Pre($grpc.ServiceCall $call, $async.Future<$0.RevokeDominionShareRequest> $request) async {
    return revokeDominionShare($call, await $request);
  }

  $async.Future<$0.RevokeDominionShareResponse> revokeDominionShare($grpc.ServiceCall call, $0.RevokeDominionShareRequest request);

  $async.Future<$0.GenerateDominionAlmanacResponse> generateDominionAlmanac_Pre($grpc.ServiceCall $call, $async.Future<$0.GenerateDominionAlmanacRequest> $request) async {
    return generateDominionAlmanac($call, await $request);
  }

  $async.Future<$0.GenerateDominionAlmanacResponse> generateDominionAlmanac($grpc.ServiceCall call, $0.GenerateDominionAlmanacRequest request);
  ...
  $async.Future<$0.ListMyLoungePassesResponse> listMyLoungePasses_Pre($grpc.ServiceCall $call, $async.Future<$0.ListMyLoungePassesRequest> $request) async {
    return listMyLoungePasses($call, await $request);
  }

  $async.Future<$0.ListMyLoungePassesResponse> listMyLoungePasses($grpc.ServiceCall call, $0.ListMyLoungePassesRequest request);
