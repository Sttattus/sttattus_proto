...
class EstateCategory extends $pb.ProtobufEnum {
  static const EstateCategory ESTATE_CATEGORY_UNSPECIFIED =
      EstateCategory._(0, _omitEnumNames ? '' : 'ESTATE_CATEGORY_UNSPECIFIED');
  static const EstateCategory ESTATE_CATEGORY_PRIMARY_RESIDENCE =
      EstateCategory._(
          1, _omitEnumNames ? '' : 'ESTATE_CATEGORY_PRIMARY_RESIDENCE');
  static const EstateCategory ESTATE_CATEGORY_COMMERCIAL_NODE =
      EstateCategory._(
          2, _omitEnumNames ? '' : 'ESTATE_CATEGORY_COMMERCIAL_NODE');
  static const EstateCategory ESTATE_CATEGORY_REMOTE_OUTPOST = EstateCategory._(
      3, _omitEnumNames ? '' : 'ESTATE_CATEGORY_REMOTE_OUTPOST');
  static const EstateCategory ESTATE_CATEGORY_STRATEGIC_LAND = EstateCategory._(
      4, _omitEnumNames ? '' : 'ESTATE_CATEGORY_STRATEGIC_LAND');
  ...
  static final $core.List<EstateCategory?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 4);
  static EstateCategory? valueOf($core.int value) =>
