...
class VaultSyncServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.GetWalletValueResponse> getWalletValue(
    $0.GetWalletValueRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$getWalletValue =
      $grpc.ClientMethod<$0.GetWalletValueRequest, $0.GetWalletValueResponse>(
...
abstract class VaultSyncServiceBase extends $grpc.Service {
  ...
  VaultSyncServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetWalletValueRequest,
            $0.GetWalletValueResponse>(
        'GetWalletValue',
        getWalletValue_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetWalletValueRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetWalletValueResponse> getWalletValue_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetWalletValueRequest> $request) async {
    return getWalletValue($call, await $request);
  }

  $async.Future<$0.GetWalletValueResponse> getWalletValue(
      $grpc.ServiceCall call, $0.GetWalletValueRequest request);
}
