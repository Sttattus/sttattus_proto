...
class DatingServiceClient extends $grpc.Client {
  ...
  /// never the image.
  $grpc.ResponseFuture<$0.ListDatingPhotosResponse> listDatingPhotos($0.ListDatingPhotosRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listDatingPhotos, request, options: options);
  }

  $grpc.ResponseFuture<$0.AddDatingPhotoResponse> addDatingPhoto($0.AddDatingPhotoRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$addDatingPhoto, request, options: options);
  }

  $grpc.ResponseFuture<$0.RemoveDatingPhotoResponse> removeDatingPhoto($0.RemoveDatingPhotoRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$removeDatingPhoto, request, options: options);
  }

  $grpc.ResponseFuture<$0.ReorderDatingPhotosResponse> reorderDatingPhotos($0.ReorderDatingPhotosRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$reorderDatingPhotos, request, options: options);
  }

  $grpc.ResponseFuture<$0.SetPrimaryDatingPhotoResponse> setPrimaryDatingPhoto($0.SetPrimaryDatingPhotoRequest request, {$grpc.CallOptions? options,}) {
  ...
  static final _$listDatingPhotos = $grpc.ClientMethod<$0.ListDatingPhotosRequest, $0.ListDatingPhotosResponse>(
  ...
  static final _$addDatingPhoto = $grpc.ClientMethod<$0.AddDatingPhotoRequest, $0.AddDatingPhotoResponse>(
  ...
  static final _$removeDatingPhoto = $grpc.ClientMethod<$0.RemoveDatingPhotoRequest, $0.RemoveDatingPhotoResponse>(
  ...
  static final _$reorderDatingPhotos = $grpc.ClientMethod<$0.ReorderDatingPhotosRequest, $0.ReorderDatingPhotosResponse>(
  ...
  static final _$setPrimaryDatingPhoto = $grpc.ClientMethod<$0.SetPrimaryDatingPhotoRequest, $0.SetPrimaryDatingPhotoResponse>(
...
abstract class DatingServiceBase extends $grpc.Service {
  ...
  DatingServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ListDatingPhotosRequest, $0.ListDatingPhotosResponse>(
        'ListDatingPhotos',
        listDatingPhotos_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListDatingPhotosRequest.fromBuffer(value),
        ($0.ListDatingPhotosResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AddDatingPhotoRequest, $0.AddDatingPhotoResponse>(
        'AddDatingPhoto',
        addDatingPhoto_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AddDatingPhotoRequest.fromBuffer(value),
        ($0.AddDatingPhotoResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RemoveDatingPhotoRequest, $0.RemoveDatingPhotoResponse>(
        'RemoveDatingPhoto',
        removeDatingPhoto_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.RemoveDatingPhotoRequest.fromBuffer(value),
        ($0.RemoveDatingPhotoResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ReorderDatingPhotosRequest, $0.ReorderDatingPhotosResponse>(
        'ReorderDatingPhotos',
        reorderDatingPhotos_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ReorderDatingPhotosRequest.fromBuffer(value),
        ($0.ReorderDatingPhotosResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SetPrimaryDatingPhotoRequest, $0.SetPrimaryDatingPhotoResponse>(
        'SetPrimaryDatingPhoto',
        setPrimaryDatingPhoto_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.SetPrimaryDatingPhotoRequest.fromBuffer(value),
  ...
  $async.Future<$0.ListDatingPhotosResponse> listDatingPhotos_Pre($grpc.ServiceCall $call, $async.Future<$0.ListDatingPhotosRequest> $request) async {
    return listDatingPhotos($call, await $request);
  }

  $async.Future<$0.ListDatingPhotosResponse> listDatingPhotos($grpc.ServiceCall call, $0.ListDatingPhotosRequest request);

  $async.Future<$0.AddDatingPhotoResponse> addDatingPhoto_Pre($grpc.ServiceCall $call, $async.Future<$0.AddDatingPhotoRequest> $request) async {
    return addDatingPhoto($call, await $request);
  }

  $async.Future<$0.AddDatingPhotoResponse> addDatingPhoto($grpc.ServiceCall call, $0.AddDatingPhotoRequest request);

  $async.Future<$0.RemoveDatingPhotoResponse> removeDatingPhoto_Pre($grpc.ServiceCall $call, $async.Future<$0.RemoveDatingPhotoRequest> $request) async {
    return removeDatingPhoto($call, await $request);
  }

  $async.Future<$0.RemoveDatingPhotoResponse> removeDatingPhoto($grpc.ServiceCall call, $0.RemoveDatingPhotoRequest request);

  $async.Future<$0.ReorderDatingPhotosResponse> reorderDatingPhotos_Pre($grpc.ServiceCall $call, $async.Future<$0.ReorderDatingPhotosRequest> $request) async {
    return reorderDatingPhotos($call, await $request);
  }

  $async.Future<$0.ReorderDatingPhotosResponse> reorderDatingPhotos($grpc.ServiceCall call, $0.ReorderDatingPhotosRequest request);

  $async.Future<$0.SetPrimaryDatingPhotoResponse> setPrimaryDatingPhoto_Pre($grpc.ServiceCall $call, $async.Future<$0.SetPrimaryDatingPhotoRequest> $request) async {
    return setPrimaryDatingPhoto($call, await $request);
  }

  $async.Future<$0.SetPrimaryDatingPhotoResponse> setPrimaryDatingPhoto($grpc.ServiceCall call, $0.SetPrimaryDatingPhotoRequest request);
