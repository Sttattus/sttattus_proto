...
class ZenithServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.ListRecentSessionsResponse> listRecentSessions($0.ListRecentSessionsRequest request, {$grpc.CallOptions? options,}) {
  ...
  $grpc.ResponseFuture<$0.ListBlockTemplatesResponse> listBlockTemplates($0.ListBlockTemplatesRequest request, {$grpc.CallOptions? options,}) {
  ...
  $grpc.ResponseFuture<$0.EnrollProgrammeResponse> enrollProgramme($0.EnrollProgrammeRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$enrollProgramme, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListMyProgrammesResponse> listMyProgrammes($0.ListMyProgrammesRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listMyProgrammes, request, options: options);
  }

  $grpc.ResponseFuture<$0.AdvanceProgrammeWeekResponse> advanceProgrammeWeek($0.AdvanceProgrammeWeekRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$advanceProgrammeWeek, request, options: options);
  }

  /// Z16.23 — journaling.
  $grpc.ResponseFuture<$0.AddJournalEntryResponse> addJournalEntry($0.AddJournalEntryRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$addJournalEntry, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListMyJournalEntriesResponse> listMyJournalEntries($0.ListMyJournalEntriesRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listMyJournalEntries, request, options: options);
  }

  /// Z16.26 — focus history + heatmap.
  $grpc.ResponseFuture<$0.GetFocusHistoryResponse> getFocusHistory($0.GetFocusHistoryRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getFocusHistory, request, options: options);
  }

  /// Z16.27 — what-if simulator.
  $grpc.ResponseFuture<$0.SimulateFortitudeResponse> simulateFortitude($0.SimulateFortitudeRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$simulateFortitude, request, options: options);
  }

  /// Z16.17 — audio environment catalog.
  $grpc.ResponseFuture<$0.ListAudioEnvironmentsResponse> listAudioEnvironments($0.ListAudioEnvironmentsRequest request, {$grpc.CallOptions? options,}) {
  ...
  $grpc.ResponseFuture<$0.GetCognitiveLoadResponse> getCognitiveLoad($0.GetCognitiveLoadRequest request, {$grpc.CallOptions? options,}) {
  ...
  $grpc.ResponseFuture<$0.AcknowledgeStressPromptResponse> acknowledgeStressPrompt($0.AcknowledgeStressPromptRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$acknowledgeStressPrompt, request, options: options);
  }
  ...
  /// Teacher directory.
  $grpc.ResponseFuture<$0.ListTeachersResponse> listTeachers($0.ListTeachersRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listTeachers, request, options: options);
  }

  /// Sovereign commissioned audio.
  $grpc.ResponseFuture<$0.ListSovereignAudioResponse> listSovereignAudio($0.ListSovereignAudioRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listSovereignAudio, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetSovereignAudioResponse> getSovereignAudio($0.GetSovereignAudioRequest request, {$grpc.CallOptions? options,}) {
  ...
  $grpc.ResponseFuture<$0.GetJournalInsightsResponse> getJournalInsights($0.GetJournalInsightsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getJournalInsights, request, options: options);
  }

  $grpc.ResponseFuture<$0.SubmitCognitiveTestResponse> submitCognitiveTest($0.SubmitCognitiveTestRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$submitCognitiveTest, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListMyCognitiveTestsResponse> listMyCognitiveTests($0.ListMyCognitiveTestsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listMyCognitiveTests, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetCognitiveTestStatusResponse> getCognitiveTestStatus($0.GetCognitiveTestStatusRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getCognitiveTestStatus, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListRitualsResponse> listRituals($0.ListRitualsRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listRituals, request, options: options);
  }

  /// ===== Phase 4 — category-leading =====
  $grpc.ResponseFuture<$0.GetYearInZenithRecapResponse> getYearInZenithRecap($0.GetYearInZenithRecapRequest request, {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$getYearInZenithRecap, request, options: options);
  }

  $grpc.ResponseFuture<$0.GenerateZenithAlmanacResponse> generateZenithAlmanac($0.GenerateZenithAlmanacRequest request, {$grpc.CallOptions? options,}) {
  ...
  static final _$listRecentSessions = $grpc.ClientMethod<$0.ListRecentSessionsRequest, $0.ListRecentSessionsResponse>(
  ...
  static final _$listBlockTemplates = $grpc.ClientMethod<$0.ListBlockTemplatesRequest, $0.ListBlockTemplatesResponse>(
  ...
  static final _$enrollProgramme = $grpc.ClientMethod<$0.EnrollProgrammeRequest, $0.EnrollProgrammeResponse>(
  ...
  static final _$listMyProgrammes = $grpc.ClientMethod<$0.ListMyProgrammesRequest, $0.ListMyProgrammesResponse>(
  ...
  static final _$advanceProgrammeWeek = $grpc.ClientMethod<$0.AdvanceProgrammeWeekRequest, $0.AdvanceProgrammeWeekResponse>(
  ...
  static final _$addJournalEntry = $grpc.ClientMethod<$0.AddJournalEntryRequest, $0.AddJournalEntryResponse>(
  ...
  static final _$listMyJournalEntries = $grpc.ClientMethod<$0.ListMyJournalEntriesRequest, $0.ListMyJournalEntriesResponse>(
  ...
  static final _$getFocusHistory = $grpc.ClientMethod<$0.GetFocusHistoryRequest, $0.GetFocusHistoryResponse>(
  ...
  static final _$simulateFortitude = $grpc.ClientMethod<$0.SimulateFortitudeRequest, $0.SimulateFortitudeResponse>(
  ...
  static final _$listAudioEnvironments = $grpc.ClientMethod<$0.ListAudioEnvironmentsRequest, $0.ListAudioEnvironmentsResponse>(
  ...
  static final _$getCognitiveLoad = $grpc.ClientMethod<$0.GetCognitiveLoadRequest, $0.GetCognitiveLoadResponse>(
  ...
  static final _$acknowledgeStressPrompt = $grpc.ClientMethod<$0.AcknowledgeStressPromptRequest, $0.AcknowledgeStressPromptResponse>(
  ...
  static final _$listTeachers = $grpc.ClientMethod<$0.ListTeachersRequest, $0.ListTeachersResponse>(
  ...
  static final _$listSovereignAudio = $grpc.ClientMethod<$0.ListSovereignAudioRequest, $0.ListSovereignAudioResponse>(
  ...
  static final _$getSovereignAudio = $grpc.ClientMethod<$0.GetSovereignAudioRequest, $0.GetSovereignAudioResponse>(
  ...
  static final _$getJournalInsights = $grpc.ClientMethod<$0.GetJournalInsightsRequest, $0.GetJournalInsightsResponse>(
  ...
  static final _$submitCognitiveTest = $grpc.ClientMethod<$0.SubmitCognitiveTestRequest, $0.SubmitCognitiveTestResponse>(
  ...
  static final _$listMyCognitiveTests = $grpc.ClientMethod<$0.ListMyCognitiveTestsRequest, $0.ListMyCognitiveTestsResponse>(
  ...
  static final _$getCognitiveTestStatus = $grpc.ClientMethod<$0.GetCognitiveTestStatusRequest, $0.GetCognitiveTestStatusResponse>(
  ...
  static final _$listRituals = $grpc.ClientMethod<$0.ListRitualsRequest, $0.ListRitualsResponse>(
  ...
  static final _$getYearInZenithRecap = $grpc.ClientMethod<$0.GetYearInZenithRecapRequest, $0.GetYearInZenithRecapResponse>(
  ...
  static final _$generateZenithAlmanac = $grpc.ClientMethod<$0.GenerateZenithAlmanacRequest, $0.GenerateZenithAlmanacResponse>(
...
abstract class ZenithServiceBase extends $grpc.Service {
  ...
  ZenithServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ListRecentSessionsRequest, $0.ListRecentSessionsResponse>(
        'ListRecentSessions',
        listRecentSessions_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListRecentSessionsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ListBlockTemplatesRequest, $0.ListBlockTemplatesResponse>(
        'ListBlockTemplates',
        listBlockTemplates_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListBlockTemplatesRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.EnrollProgrammeRequest, $0.EnrollProgrammeResponse>(
        'EnrollProgramme',
        enrollProgramme_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.EnrollProgrammeRequest.fromBuffer(value),
        ($0.EnrollProgrammeResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListMyProgrammesRequest, $0.ListMyProgrammesResponse>(
        'ListMyProgrammes',
        listMyProgrammes_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListMyProgrammesRequest.fromBuffer(value),
        ($0.ListMyProgrammesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AdvanceProgrammeWeekRequest, $0.AdvanceProgrammeWeekResponse>(
        'AdvanceProgrammeWeek',
        advanceProgrammeWeek_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AdvanceProgrammeWeekRequest.fromBuffer(value),
        ($0.AdvanceProgrammeWeekResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AddJournalEntryRequest, $0.AddJournalEntryResponse>(
        'AddJournalEntry',
        addJournalEntry_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AddJournalEntryRequest.fromBuffer(value),
        ($0.AddJournalEntryResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListMyJournalEntriesRequest, $0.ListMyJournalEntriesResponse>(
        'ListMyJournalEntries',
        listMyJournalEntries_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListMyJournalEntriesRequest.fromBuffer(value),
        ($0.ListMyJournalEntriesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetFocusHistoryRequest, $0.GetFocusHistoryResponse>(
        'GetFocusHistory',
        getFocusHistory_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetFocusHistoryRequest.fromBuffer(value),
        ($0.GetFocusHistoryResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SimulateFortitudeRequest, $0.SimulateFortitudeResponse>(
        'SimulateFortitude',
        simulateFortitude_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.SimulateFortitudeRequest.fromBuffer(value),
        ($0.SimulateFortitudeResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListAudioEnvironmentsRequest, $0.ListAudioEnvironmentsResponse>(
        'ListAudioEnvironments',
        listAudioEnvironments_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListAudioEnvironmentsRequest.fromBuffer(value),
        ($0.ListAudioEnvironmentsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetCognitiveLoadRequest, $0.GetCognitiveLoadResponse>(
        'GetCognitiveLoad',
        getCognitiveLoad_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetCognitiveLoadRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.AcknowledgeStressPromptRequest, $0.AcknowledgeStressPromptResponse>(
        'AcknowledgeStressPrompt',
        acknowledgeStressPrompt_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AcknowledgeStressPromptRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ListTeachersRequest, $0.ListTeachersResponse>(
        'ListTeachers',
        listTeachers_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListTeachersRequest.fromBuffer(value),
        ($0.ListTeachersResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListSovereignAudioRequest, $0.ListSovereignAudioResponse>(
        'ListSovereignAudio',
        listSovereignAudio_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListSovereignAudioRequest.fromBuffer(value),
        ($0.ListSovereignAudioResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetSovereignAudioRequest, $0.GetSovereignAudioResponse>(
        'GetSovereignAudio',
        getSovereignAudio_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetSovereignAudioRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.GetJournalInsightsRequest, $0.GetJournalInsightsResponse>(
        'GetJournalInsights',
        getJournalInsights_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetJournalInsightsRequest.fromBuffer(value),
        ($0.GetJournalInsightsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SubmitCognitiveTestRequest, $0.SubmitCognitiveTestResponse>(
        'SubmitCognitiveTest',
        submitCognitiveTest_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.SubmitCognitiveTestRequest.fromBuffer(value),
        ($0.SubmitCognitiveTestResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListMyCognitiveTestsRequest, $0.ListMyCognitiveTestsResponse>(
        'ListMyCognitiveTests',
        listMyCognitiveTests_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListMyCognitiveTestsRequest.fromBuffer(value),
        ($0.ListMyCognitiveTestsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetCognitiveTestStatusRequest, $0.GetCognitiveTestStatusResponse>(
        'GetCognitiveTestStatus',
        getCognitiveTestStatus_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetCognitiveTestStatusRequest.fromBuffer(value),
        ($0.GetCognitiveTestStatusResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListRitualsRequest, $0.ListRitualsResponse>(
        'ListRituals',
        listRituals_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ListRitualsRequest.fromBuffer(value),
        ($0.ListRitualsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetYearInZenithRecapRequest, $0.GetYearInZenithRecapResponse>(
        'GetYearInZenithRecap',
        getYearInZenithRecap_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetYearInZenithRecapRequest.fromBuffer(value),
        ($0.GetYearInZenithRecapResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GenerateZenithAlmanacRequest, $0.GenerateZenithAlmanacResponse>(
        'GenerateZenithAlmanac',
        generateZenithAlmanac_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GenerateZenithAlmanacRequest.fromBuffer(value),
  ...
  $async.Future<$0.ListRecentSessionsResponse> listRecentSessions_Pre($grpc.ServiceCall $call, $async.Future<$0.ListRecentSessionsRequest> $request) async {
    return listRecentSessions($call, await $request);
  }

  $async.Future<$0.ListRecentSessionsResponse> listRecentSessions($grpc.ServiceCall call, $0.ListRecentSessionsRequest request);
  ...
  $async.Future<$0.ListBlockTemplatesResponse> listBlockTemplates_Pre($grpc.ServiceCall $call, $async.Future<$0.ListBlockTemplatesRequest> $request) async {
    return listBlockTemplates($call, await $request);
  }

  $async.Future<$0.ListBlockTemplatesResponse> listBlockTemplates($grpc.ServiceCall call, $0.ListBlockTemplatesRequest request);
  ...
  $async.Future<$0.EnrollProgrammeResponse> enrollProgramme_Pre($grpc.ServiceCall $call, $async.Future<$0.EnrollProgrammeRequest> $request) async {
    return enrollProgramme($call, await $request);
  }

  $async.Future<$0.EnrollProgrammeResponse> enrollProgramme($grpc.ServiceCall call, $0.EnrollProgrammeRequest request);

  $async.Future<$0.ListMyProgrammesResponse> listMyProgrammes_Pre($grpc.ServiceCall $call, $async.Future<$0.ListMyProgrammesRequest> $request) async {
    return listMyProgrammes($call, await $request);
  }

  $async.Future<$0.ListMyProgrammesResponse> listMyProgrammes($grpc.ServiceCall call, $0.ListMyProgrammesRequest request);

  $async.Future<$0.AdvanceProgrammeWeekResponse> advanceProgrammeWeek_Pre($grpc.ServiceCall $call, $async.Future<$0.AdvanceProgrammeWeekRequest> $request) async {
    return advanceProgrammeWeek($call, await $request);
  }

  $async.Future<$0.AdvanceProgrammeWeekResponse> advanceProgrammeWeek($grpc.ServiceCall call, $0.AdvanceProgrammeWeekRequest request);

  $async.Future<$0.AddJournalEntryResponse> addJournalEntry_Pre($grpc.ServiceCall $call, $async.Future<$0.AddJournalEntryRequest> $request) async {
    return addJournalEntry($call, await $request);
  }

  $async.Future<$0.AddJournalEntryResponse> addJournalEntry($grpc.ServiceCall call, $0.AddJournalEntryRequest request);

  $async.Future<$0.ListMyJournalEntriesResponse> listMyJournalEntries_Pre($grpc.ServiceCall $call, $async.Future<$0.ListMyJournalEntriesRequest> $request) async {
    return listMyJournalEntries($call, await $request);
  }

  $async.Future<$0.ListMyJournalEntriesResponse> listMyJournalEntries($grpc.ServiceCall call, $0.ListMyJournalEntriesRequest request);

  $async.Future<$0.GetFocusHistoryResponse> getFocusHistory_Pre($grpc.ServiceCall $call, $async.Future<$0.GetFocusHistoryRequest> $request) async {
    return getFocusHistory($call, await $request);
  }

  $async.Future<$0.GetFocusHistoryResponse> getFocusHistory($grpc.ServiceCall call, $0.GetFocusHistoryRequest request);

  $async.Future<$0.SimulateFortitudeResponse> simulateFortitude_Pre($grpc.ServiceCall $call, $async.Future<$0.SimulateFortitudeRequest> $request) async {
    return simulateFortitude($call, await $request);
  }

  $async.Future<$0.SimulateFortitudeResponse> simulateFortitude($grpc.ServiceCall call, $0.SimulateFortitudeRequest request);

  $async.Future<$0.ListAudioEnvironmentsResponse> listAudioEnvironments_Pre($grpc.ServiceCall $call, $async.Future<$0.ListAudioEnvironmentsRequest> $request) async {
    return listAudioEnvironments($call, await $request);
  }

  $async.Future<$0.ListAudioEnvironmentsResponse> listAudioEnvironments($grpc.ServiceCall call, $0.ListAudioEnvironmentsRequest request);

  $async.Future<$0.GetCognitiveLoadResponse> getCognitiveLoad_Pre($grpc.ServiceCall $call, $async.Future<$0.GetCognitiveLoadRequest> $request) async {
    return getCognitiveLoad($call, await $request);
  }

  $async.Future<$0.GetCognitiveLoadResponse> getCognitiveLoad($grpc.ServiceCall call, $0.GetCognitiveLoadRequest request);
  ...
  $async.Future<$0.AcknowledgeStressPromptResponse> acknowledgeStressPrompt_Pre($grpc.ServiceCall $call, $async.Future<$0.AcknowledgeStressPromptRequest> $request) async {
    return acknowledgeStressPrompt($call, await $request);
  }

  $async.Future<$0.AcknowledgeStressPromptResponse> acknowledgeStressPrompt($grpc.ServiceCall call, $0.AcknowledgeStressPromptRequest request);
  ...
  $async.Future<$0.ListTeachersResponse> listTeachers_Pre($grpc.ServiceCall $call, $async.Future<$0.ListTeachersRequest> $request) async {
    return listTeachers($call, await $request);
  }

  $async.Future<$0.ListTeachersResponse> listTeachers($grpc.ServiceCall call, $0.ListTeachersRequest request);

  $async.Future<$0.ListSovereignAudioResponse> listSovereignAudio_Pre($grpc.ServiceCall $call, $async.Future<$0.ListSovereignAudioRequest> $request) async {
    return listSovereignAudio($call, await $request);
  }

  $async.Future<$0.ListSovereignAudioResponse> listSovereignAudio($grpc.ServiceCall call, $0.ListSovereignAudioRequest request);

  $async.Future<$0.GetSovereignAudioResponse> getSovereignAudio_Pre($grpc.ServiceCall $call, $async.Future<$0.GetSovereignAudioRequest> $request) async {
    return getSovereignAudio($call, await $request);
  }

  $async.Future<$0.GetSovereignAudioResponse> getSovereignAudio($grpc.ServiceCall call, $0.GetSovereignAudioRequest request);
  ...
  $async.Future<$0.GetJournalInsightsResponse> getJournalInsights_Pre($grpc.ServiceCall $call, $async.Future<$0.GetJournalInsightsRequest> $request) async {
    return getJournalInsights($call, await $request);
  }

  $async.Future<$0.GetJournalInsightsResponse> getJournalInsights($grpc.ServiceCall call, $0.GetJournalInsightsRequest request);

  $async.Future<$0.SubmitCognitiveTestResponse> submitCognitiveTest_Pre($grpc.ServiceCall $call, $async.Future<$0.SubmitCognitiveTestRequest> $request) async {
    return submitCognitiveTest($call, await $request);
  }

  $async.Future<$0.SubmitCognitiveTestResponse> submitCognitiveTest($grpc.ServiceCall call, $0.SubmitCognitiveTestRequest request);

  $async.Future<$0.ListMyCognitiveTestsResponse> listMyCognitiveTests_Pre($grpc.ServiceCall $call, $async.Future<$0.ListMyCognitiveTestsRequest> $request) async {
    return listMyCognitiveTests($call, await $request);
  }

  $async.Future<$0.ListMyCognitiveTestsResponse> listMyCognitiveTests($grpc.ServiceCall call, $0.ListMyCognitiveTestsRequest request);

  $async.Future<$0.GetCognitiveTestStatusResponse> getCognitiveTestStatus_Pre($grpc.ServiceCall $call, $async.Future<$0.GetCognitiveTestStatusRequest> $request) async {
    return getCognitiveTestStatus($call, await $request);
  }

  $async.Future<$0.GetCognitiveTestStatusResponse> getCognitiveTestStatus($grpc.ServiceCall call, $0.GetCognitiveTestStatusRequest request);

  $async.Future<$0.ListRitualsResponse> listRituals_Pre($grpc.ServiceCall $call, $async.Future<$0.ListRitualsRequest> $request) async {
    return listRituals($call, await $request);
  }

  $async.Future<$0.ListRitualsResponse> listRituals($grpc.ServiceCall call, $0.ListRitualsRequest request);

  $async.Future<$0.GetYearInZenithRecapResponse> getYearInZenithRecap_Pre($grpc.ServiceCall $call, $async.Future<$0.GetYearInZenithRecapRequest> $request) async {
    return getYearInZenithRecap($call, await $request);
  }

  $async.Future<$0.GetYearInZenithRecapResponse> getYearInZenithRecap($grpc.ServiceCall call, $0.GetYearInZenithRecapRequest request);

  $async.Future<$0.GenerateZenithAlmanacResponse> generateZenithAlmanac_Pre($grpc.ServiceCall $call, $async.Future<$0.GenerateZenithAlmanacRequest> $request) async {
    return generateZenithAlmanac($call, await $request);
  }

  $async.Future<$0.GenerateZenithAlmanacResponse> generateZenithAlmanac($grpc.ServiceCall call, $0.GenerateZenithAlmanacRequest request);
