...
class AssetCategory extends $pb.ProtobufEnum {
  ...
  static const AssetCategory ASSET_CATEGORY_INTELLECTUAL_PROPERTY =
      AssetCategory._(
          1, _omitEnumNames ? '' : 'ASSET_CATEGORY_INTELLECTUAL_PROPERTY');
  static const AssetCategory ASSET_CATEGORY_CORPORATE_GOVERNANCE =
      AssetCategory._(
          2, _omitEnumNames ? '' : 'ASSET_CATEGORY_CORPORATE_GOVERNANCE');
  static const AssetCategory ASSET_CATEGORY_ESTATE_PLANNING = AssetCategory._(
      3, _omitEnumNames ? '' : 'ASSET_CATEGORY_ESTATE_PLANNING');
  static const AssetCategory ASSET_CATEGORY_HIGH_STAKES_CONTRACTS =
      AssetCategory._(
          4, _omitEnumNames ? '' : 'ASSET_CATEGORY_HIGH_STAKES_CONTRACTS');
