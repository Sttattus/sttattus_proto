...
class ApexEngineServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.CalculateBioRankResponse> calculateBioRank(
    $0.CalculateBioRankRequest request, {
  ...
  static final _$calculateBioRank = $grpc.ClientMethod<
          $0.CalculateBioRankRequest, $0.CalculateBioRankResponse>(
...
abstract class ApexEngineServiceBase extends $grpc.Service {
  ...
  ApexEngineServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.CalculateBioRankRequest,
            $0.CalculateBioRankResponse>(
        'CalculateBioRank',
        calculateBioRank_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.CalculateBioRankRequest.fromBuffer(value),
        ($0.CalculateBioRankResponse value) => value.writeToBuffer()));
  }

  $async.Future<$0.CalculateBioRankResponse> calculateBioRank_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.CalculateBioRankRequest> $request) async {
    return calculateBioRank($call, await $request);
  }

  $async.Future<$0.CalculateBioRankResponse> calculateBioRank(
      $grpc.ServiceCall call, $0.CalculateBioRankRequest request);
}
