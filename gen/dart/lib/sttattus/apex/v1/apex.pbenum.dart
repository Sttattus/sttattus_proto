...
class BiomarkerCategory extends $pb.ProtobufEnum {
  static const BiomarkerCategory BIOMARKER_CATEGORY_UNSPECIFIED =
      BiomarkerCategory._(
          0, _omitEnumNames ? '' : 'BIOMARKER_CATEGORY_UNSPECIFIED');
  static const BiomarkerCategory BIOMARKER_CATEGORY_LIPIDS =
      BiomarkerCategory._(1, _omitEnumNames ? '' : 'BIOMARKER_CATEGORY_LIPIDS');
  static const BiomarkerCategory BIOMARKER_CATEGORY_METABOLIC =
      BiomarkerCategory._(
          2, _omitEnumNames ? '' : 'BIOMARKER_CATEGORY_METABOLIC');
  static const BiomarkerCategory BIOMARKER_CATEGORY_HORMONES =
      BiomarkerCategory._(
          3, _omitEnumNames ? '' : 'BIOMARKER_CATEGORY_HORMONES');
  static const BiomarkerCategory BIOMARKER_CATEGORY_INFLAMMATION =
      BiomarkerCategory._(
          4, _omitEnumNames ? '' : 'BIOMARKER_CATEGORY_INFLAMMATION');
  static const BiomarkerCategory BIOMARKER_CATEGORY_VITAMINS =
      BiomarkerCategory._(
          5, _omitEnumNames ? '' : 'BIOMARKER_CATEGORY_VITAMINS');
  static const BiomarkerCategory BIOMARKER_CATEGORY_SENSORS =
      BiomarkerCategory._(
          6, _omitEnumNames ? '' : 'BIOMARKER_CATEGORY_SENSORS');
  ...
  static final $core.List<BiomarkerCategory?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 6);
  static BiomarkerCategory? valueOf($core.int value) =>
