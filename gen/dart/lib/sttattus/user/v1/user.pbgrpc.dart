...
class UserServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.ListAppAccessResponse> listAppAccess(
    $0.ListAppAccessRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$listAppAccess, request, options: options);
  }

  $grpc.ResponseFuture<$0.GrantAppResponse> grantApp(
    $0.GrantAppRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$grantApp, request, options: options);
  }

  $grpc.ResponseFuture<$0.AppHeartbeatResponse> appHeartbeat(
    $0.AppHeartbeatRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.GetSttattusResponse> getSttattus(
    $0.GetSttattusRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getSttattus, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListLeaderboardResponse> listLeaderboard(
    $0.ListLeaderboardRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$listAppAccess =
      $grpc.ClientMethod<$0.ListAppAccessRequest, $0.ListAppAccessResponse>(
  ...
  static final _$grantApp =
      $grpc.ClientMethod<$0.GrantAppRequest, $0.GrantAppResponse>(
          '/sttattus.user.v1.UserService/GrantApp',
          ($0.GrantAppRequest value) => value.writeToBuffer(),
          $0.GrantAppResponse.fromBuffer);
  static final _$appHeartbeat =
      $grpc.ClientMethod<$0.AppHeartbeatRequest, $0.AppHeartbeatResponse>(
  ...
  static final _$getSttattus =
      $grpc.ClientMethod<$0.GetSttattusRequest, $0.GetSttattusResponse>(
          '/sttattus.user.v1.UserService/GetSttattus',
          ($0.GetSttattusRequest value) => value.writeToBuffer(),
          $0.GetSttattusResponse.fromBuffer);
  static final _$listLeaderboard =
      $grpc.ClientMethod<$0.ListLeaderboardRequest, $0.ListLeaderboardResponse>(
...
abstract class UserServiceBase extends $grpc.Service {
  ...
  UserServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.ListAppAccessRequest, $0.ListAppAccessResponse>(
            'ListAppAccess',
            listAppAccess_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.ListAppAccessRequest.fromBuffer(value),
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.AppHeartbeatRequest, $0.AppHeartbeatResponse>(
            'AppHeartbeat',
            appHeartbeat_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.AppHeartbeatRequest.fromBuffer(value),
            ($0.AppHeartbeatResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.GetSttattusRequest, $0.GetSttattusResponse>(
            'GetSttattus',
            getSttattus_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.GetSttattusRequest.fromBuffer(value),
            ($0.GetSttattusResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListLeaderboardRequest,
            $0.ListLeaderboardResponse>(
        'ListLeaderboard',
        listLeaderboard_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ListLeaderboardRequest.fromBuffer(value),
  ...
  $async.Future<$0.ListAppAccessResponse> listAppAccess_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ListAppAccessRequest> $request) async {
    return listAppAccess($call, await $request);
  }

  $async.Future<$0.ListAppAccessResponse> listAppAccess(
      $grpc.ServiceCall call, $0.ListAppAccessRequest request);

  $async.Future<$0.GrantAppResponse> grantApp_Pre($grpc.ServiceCall $call,
      $async.Future<$0.GrantAppRequest> $request) async {
    return grantApp($call, await $request);
  }

  $async.Future<$0.GrantAppResponse> grantApp(
      $grpc.ServiceCall call, $0.GrantAppRequest request);

  $async.Future<$0.AppHeartbeatResponse> appHeartbeat_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.AppHeartbeatRequest> $request) async {
    return appHeartbeat($call, await $request);
  }

  $async.Future<$0.AppHeartbeatResponse> appHeartbeat(
      $grpc.ServiceCall call, $0.AppHeartbeatRequest request);

  $async.Future<$0.GetSttattusResponse> getSttattus_Pre($grpc.ServiceCall $call,
      $async.Future<$0.GetSttattusRequest> $request) async {
    return getSttattus($call, await $request);
  }

  $async.Future<$0.GetSttattusResponse> getSttattus(
      $grpc.ServiceCall call, $0.GetSttattusRequest request);

  $async.Future<$0.ListLeaderboardResponse> listLeaderboard_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ListLeaderboardRequest> $request) async {
    return listLeaderboard($call, await $request);
  }

  $async.Future<$0.ListLeaderboardResponse> listLeaderboard(
      $grpc.ServiceCall call, $0.ListLeaderboardRequest request);
}
