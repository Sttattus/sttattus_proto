...
const $core.Map<$core.String, $core.dynamic> AdminServiceBase$json = {
  ...
  '2': [
    {
      '1': 'ListUsers',
      '2': '.sttattus.admin.v1.ListUsersRequest',
      '3': '.sttattus.admin.v1.ListUsersResponse'
    },
    {
      '1': 'GetUser',
      '2': '.sttattus.admin.v1.GetUserRequest',
      '3': '.sttattus.admin.v1.GetUserResponse'
    },
    {
      '1': 'BanUser',
      '2': '.sttattus.admin.v1.BanUserRequest',
      '3': '.sttattus.admin.v1.BanUserResponse'
    },
    {
      '1': 'BulkAction',
      '2': '.sttattus.admin.v1.BulkActionRequest',
      '3': '.sttattus.admin.v1.BulkActionResponse'
    },
    {
      '1': 'ListAuditLogs',
      '2': '.sttattus.admin.v1.ListAuditLogsRequest',
      '3': '.sttattus.admin.v1.ListAuditLogsResponse'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.sttattus.admin.v1.ListUsersRequest': ListUsersRequest$json,
  '.sttattus.common.v1.PageRequest': $1.PageRequest$json,
  '.sttattus.admin.v1.ListUsersResponse': ListUsersResponse$json,
  '.sttattus.admin.v1.AdminUserRow': AdminUserRow$json,
  '.sttattus.user.v1.UserProfile': $0.UserProfile$json,
  '.sttattus.user.v1.AppAccess': $0.AppAccess$json,
  '.sttattus.common.v1.PageResponse': $1.PageResponse$json,
  '.sttattus.admin.v1.GetUserRequest': GetUserRequest$json,
  '.sttattus.admin.v1.GetUserResponse': GetUserResponse$json,
  '.sttattus.admin.v1.BanUserRequest': BanUserRequest$json,
  '.sttattus.admin.v1.BanUserResponse': BanUserResponse$json,
  '.sttattus.admin.v1.BulkActionRequest': BulkActionRequest$json,
  '.sttattus.admin.v1.BulkActionResponse': BulkActionResponse$json,
  '.sttattus.admin.v1.ListAuditLogsRequest': ListAuditLogsRequest$json,
  '.sttattus.admin.v1.ListAuditLogsResponse': ListAuditLogsResponse$json,
  '.sttattus.admin.v1.AuditLogEntry': AuditLogEntry$json,
};
...
final $typed_data.Uint8List adminServiceDescriptor = $convert.base64Decode(
    'CgxBZG1pblNlcnZpY2USVgoJTGlzdFVzZXJzEiMuc3R0YXR0dXMuYWRtaW4udjEuTGlzdFVzZX'
    'JzUmVxdWVzdBokLnN0dGF0dHVzLmFkbWluLnYxLkxpc3RVc2Vyc1Jlc3BvbnNlElAKB0dldFVz'
    'ZXISIS5zdHRhdHR1cy5hZG1pbi52MS5HZXRVc2VyUmVxdWVzdBoiLnN0dGF0dHVzLmFkbWluLn'
    'YxLkdldFVzZXJSZXNwb25zZRJQCgdCYW5Vc2VyEiEuc3R0YXR0dXMuYWRtaW4udjEuQmFuVXNl'
    'clJlcXVlc3QaIi5zdHRhdHR1cy5hZG1pbi52MS5CYW5Vc2VyUmVzcG9uc2USWQoKQnVsa0FjdG'
    'lvbhIkLnN0dGF0dHVzLmFkbWluLnYxLkJ1bGtBY3Rpb25SZXF1ZXN0GiUuc3R0YXR0dXMuYWRt'
    'aW4udjEuQnVsa0FjdGlvblJlc3BvbnNlEmIKDUxpc3RBdWRpdExvZ3MSJy5zdHRhdHR1cy5hZG'
    '1pbi52MS5MaXN0QXVkaXRMb2dzUmVxdWVzdBooLnN0dGF0dHVzLmFkbWluLnYxLkxpc3RBdWRp'
    'dExvZ3NSZXNwb25zZQ==');
