...
import '../../auth/v1/auth.pbenum.dart' as $2;
...
class AdminUserRow extends $pb.GeneratedMessage {
  factory AdminUserRow({
    ...
    $core.Iterable<$0.AppAccess>? apps,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.UserProfile>(1, _omitFieldNames ? '' : 'profile',
        subBuilder: $0.UserProfile.create)
    ..pPM<$0.AppAccess>(2, _omitFieldNames ? '' : 'apps',
        subBuilder: $0.AppAccess.create)
  ...
  @$pb.TagNumber(1)
  $0.UserProfile get profile => $_getN(0);
  @$pb.TagNumber(1)
  set profile($0.UserProfile value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasProfile() => $_has(0);
  @$pb.TagNumber(1)
  void clearProfile() => $_clearField(1);
  @$pb.TagNumber(1)
  $0.UserProfile ensureProfile() => $_ensure(0);

  @$pb.TagNumber(2)
  $pb.PbList<$0.AppAccess> get apps => $_getList(1);
}
...
class ListUsersRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<$2.AppCode>(3, _omitFieldNames ? '' : 'filterByApp',
        enumValues: $2.AppCode.values)
  ...
  @$pb.TagNumber(3)
  $2.AppCode get filterByApp => $_getN(2);
  @$pb.TagNumber(3)
  set filterByApp($2.AppCode value) => $_setField(3, value);
  @$pb.TagNumber(3)
...
class BulkActionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<$2.AppCode>(3, _omitFieldNames ? '' : 'appCode',
        enumValues: $2.AppCode.values)
  ...
  @$pb.TagNumber(3)
  $2.AppCode get appCode => $_getN(2);
  @$pb.TagNumber(3)
  set appCode($2.AppCode value) => $_setField(3, value);
  @$pb.TagNumber(3)
...
class AdminServiceApi {
  ...
  $async.Future<BulkActionResponse> bulkAction(
          $pb.ClientContext? ctx, BulkActionRequest request) =>
      _client.invoke<BulkActionResponse>(
          ctx, 'AdminService', 'BulkAction', request, BulkActionResponse());
  $async.Future<ListAuditLogsResponse> listAuditLogs(
          $pb.ClientContext? ctx, ListAuditLogsRequest request) =>
      _client.invoke<ListAuditLogsResponse>(ctx, 'AdminService',
