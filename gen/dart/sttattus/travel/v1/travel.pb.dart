...
class NomadStats extends $pb.GeneratedMessage {
  factory NomadStats({
    ...
    if (completedMilestones != null)
      result.completedMilestones = completedMilestones;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(5, _omitFieldNames ? '' : 'completedMilestones')
...
class FeedPost extends $pb.GeneratedMessage {
  ...
  factory FeedPost.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FeedPost.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FeedPost',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.travel.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FeedPost clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FeedPost copyWith(void Function(FeedPost) updates) =>
      super.copyWith((message) => updates(message as FeedPost)) as FeedPost;
  ...
  @$core.pragma('dart2js:noInline')
  static FeedPost getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FeedPost>(create);
...
class ListMilestonesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOM<$0.PageRequest>(2, _omitFieldNames ? '' : 'page',
  ...
  @$pb.TagNumber(2)
  $0.PageRequest get page => $_getN(1);
  @$pb.TagNumber(2)
  set page($0.PageRequest value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasPage() => $_has(1);
  @$pb.TagNumber(2)
  void clearPage() => $_clearField(2);
  @$pb.TagNumber(2)
  $0.PageRequest ensurePage() => $_ensure(1);
}
...
class ListFeedResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.travel.v1'),
      createEmptyInstance: create)
    ..pPM<FeedPost>(1, _omitFieldNames ? '' : 'posts',
        subBuilder: FeedPost.create)
    ..aOM<$0.PageResponse>(2, _omitFieldNames ? '' : 'page',
        subBuilder: $0.PageResponse.create)
    ..hasRequiredFields = false;
...
class LikePostResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'sttattus.travel.v1'),
      createEmptyInstance: create)
    ..aI(1, _omitFieldNames ? '' : 'likesCount')
...
class TravelServiceApi {
  ...
  $async.Future<ListMilestonesResponse> listMilestones(
          $pb.ClientContext? ctx, ListMilestonesRequest request) =>
      _client.invoke<ListMilestonesResponse>(ctx, 'TravelService',
          'ListMilestones', request, ListMilestonesResponse());
  $async.Future<CreateMilestoneResponse> createMilestone(
          $pb.ClientContext? ctx, CreateMilestoneRequest request) =>
      _client.invoke<CreateMilestoneResponse>(ctx, 'TravelService',
          'CreateMilestone', request, CreateMilestoneResponse());
  $async.Future<GetNomadStatsResponse> getNomadStats(
          $pb.ClientContext? ctx, GetNomadStatsRequest request) =>
      _client.invoke<GetNomadStatsResponse>(ctx, 'TravelService',
          'GetNomadStats', request, GetNomadStatsResponse());
  $async.Future<ListFeedResponse> listFeed(
          $pb.ClientContext? ctx, ListFeedRequest request) =>
      _client.invoke<ListFeedResponse>(
          ctx, 'TravelService', 'ListFeed', request, ListFeedResponse());
  $async.Future<LikePostResponse> likePost(
          $pb.ClientContext? ctx, LikePostRequest request) =>
      _client.invoke<LikePostResponse>(
          ctx, 'TravelService', 'LikePost', request, LikePostResponse());
}
