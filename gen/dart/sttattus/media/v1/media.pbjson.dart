...
const $core.Map<$core.String, $core.dynamic> MediaServiceBase$json = {
  ...
  '2': [
    {
      '1': 'RequestUpload',
      '2': '.sttattus.media.v1.RequestUploadRequest',
      '3': '.sttattus.media.v1.RequestUploadResponse'
    },
    {
      '1': 'MarkProcessed',
      '2': '.sttattus.media.v1.MarkProcessedRequest',
      '3': '.sttattus.media.v1.MarkProcessedResponse'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.sttattus.media.v1.RequestUploadRequest': RequestUploadRequest$json,
  '.sttattus.media.v1.RequestUploadResponse': RequestUploadResponse$json,
  '.sttattus.media.v1.MarkProcessedRequest': MarkProcessedRequest$json,
  '.sttattus.media.v1.MarkProcessedResponse': MarkProcessedResponse$json,
  '.sttattus.media.v1.MediaAsset': MediaAsset$json,
};
...
final $typed_data.Uint8List mediaServiceDescriptor = $convert.base64Decode(
    'CgxNZWRpYVNlcnZpY2USYgoNUmVxdWVzdFVwbG9hZBInLnN0dGF0dHVzLm1lZGlhLnYxLlJlcX'
    'Vlc3RVcGxvYWRSZXF1ZXN0Giguc3R0YXR0dXMubWVkaWEudjEuUmVxdWVzdFVwbG9hZFJlc3Bv'
    'bnNlEmIKDU1hcmtQcm9jZXNzZWQSJy5zdHRhdHR1cy5tZWRpYS52MS5NYXJrUHJvY2Vzc2VkUm'
    'VxdWVzdBooLnN0dGF0dHVzLm1lZGlhLnYxLk1hcmtQcm9jZXNzZWRSZXNwb25zZQ==');

const $core.Map<$core.String, $core.dynamic> ImageProcServiceBase$json = {
  '1': 'ImageProcService',
  '2': [
    {
      '1': 'Resize',
      '2': '.sttattus.media.v1.ResizeRequest',
      '3': '.sttattus.media.v1.ResizeResponse'
    },
    {
      '1': 'ExtractDominantColors',
      '2': '.sttattus.media.v1.ExtractDominantColorsRequest',
      '3': '.sttattus.media.v1.ExtractDominantColorsResponse'
    },
  ],
};

@$core.Deprecated('Use imageProcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    ImageProcServiceBase$messageJson = {
  '.sttattus.media.v1.ResizeRequest': ResizeRequest$json,
  '.sttattus.media.v1.ResizeResponse': ResizeResponse$json,
  '.sttattus.media.v1.ExtractDominantColorsRequest':
      ExtractDominantColorsRequest$json,
  '.sttattus.media.v1.ExtractDominantColorsResponse':
      ExtractDominantColorsResponse$json,
};

/// Descriptor for `ImageProcService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List imageProcServiceDescriptor = $convert.base64Decode(
    'ChBJbWFnZVByb2NTZXJ2aWNlEk0KBlJlc2l6ZRIgLnN0dGF0dHVzLm1lZGlhLnYxLlJlc2l6ZV'
    'JlcXVlc3QaIS5zdHRhdHR1cy5tZWRpYS52MS5SZXNpemVSZXNwb25zZRJ6ChVFeHRyYWN0RG9t'
    'aW5hbnRDb2xvcnMSLy5zdHRhdHR1cy5tZWRpYS52MS5FeHRyYWN0RG9taW5hbnRDb2xvcnNSZX'
    'F1ZXN0GjAuc3R0YXR0dXMubWVkaWEudjEuRXh0cmFjdERvbWluYW50Q29sb3JzUmVzcG9uc2U=');
